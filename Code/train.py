...
eventlogs = ["data/BPI17.csv", "data/BPI20.csv","data/helpdesk.csv"]
for eventlog in eventlogs:
    ...
    '''
    #LSTM
    X,y_a,y_t = vectorize(char_indices,divisor,divisor2,next_chars_t,next_chars,chars,sentences,maxlen,target_chars,target_char_indices
